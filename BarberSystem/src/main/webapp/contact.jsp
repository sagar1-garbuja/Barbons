...
<head>
  ...
  <style>
    ...
    @media (max-width: 768px) {
      .page-tabs { padding: 0 14px; overflow-x: auto; flex-wrap: nowrap; }
      .page-tab  { white-space: nowrap; padding: 10px 14px; font-size: .8rem; }
      .contact-layout {
    ...
    @media (max-width: 480px) {
      ...
      .page-tab { padding: 8px 10px; font-size: .75rem; }
    }
...
<div class="success-popup <%= messageSent ? "show" : "" %>">
  <div class="success-box">
    ...
    <a href="${pageContext.request.contextPath}/contact.jsp">Back to Contact</a>
  </div>
</div>
...
<!-- ── PAGE TABS ── -->
<div class="page-tabs">
  <a href="${pageContext.request.contextPath}/index.jsp" class="page-tab">Home</a>
  <% if (loggedInName != null && !"admin".equals(loggedInRole)) { %>
    <a href="${pageContext.request.contextPath}/customer/dashboard.jsp" class="page-tab">Dashboard</a>
    <a href="${pageContext.request.contextPath}/customer/book.jsp" class="page-tab">Book</a>
    <a href="${pageContext.request.contextPath}/customer/my-appointments.jsp" class="page-tab">Appointments</a>
  <% } %>
  <a href="${pageContext.request.contextPath}/reviews.jsp" class="page-tab">Reviews</a>
  <a href="${pageContext.request.contextPath}/contact.jsp" class="page-tab active">Contact</a>
</div>
...
<div class="contact-layout">
  ...
  <div class="contact-left">
    ...
    <div class="contact-form">
      ...
      <form method="get" action="${pageContext.request.contextPath}/contact.jsp">
    ...
    <table class="hours-table" style="margin-top:32px;">
      ...
      <tbody>
        <tr><td>Sunday</td><td>8 AM – 7 PM</td></tr>
        <tr><td>Monday</td><td>8 AM – 7 PM</td></tr>
        <tr><td>Tuesday</td><td>8 AM – 7 PM</td></tr>
